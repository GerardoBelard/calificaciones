...
<html lang="en">
    <head>
        ...
        <title>Añadir Años de Clase</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Añadir Años de Clase</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><a href="#">Años de Clase</a></li>
            							<li class="active">Crear Años de Clase</li>
            						</ul>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Número de Año Escolar</label>
                                                        <div class="">
