                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Sistema de Gestión de Resultados Escolares</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Ingresa tu id de Matrícula</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Ingresa tu id de Matrícula" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
...
<?php }} ?>
                                    ...
                                    <div class="form-group mt-20">
                                        <div class="">
                                            ...
                                            <button type="submit" class="btn btn-success btn-labeled pull-right">Búsqueda<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
